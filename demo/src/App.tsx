    ...
    >
      <div style={{ maxWidth: 560, margin: "0 auto", padding: "60px 40px 60px" }}>
        ...
        <p style={{ fontSize: 16, lineHeight: 2.2, margin: 0 }}>
          ...
          <Bloom type="line" backgroundColor={c.rose} paddingX={4} paddingY={2} scale={2} tip="square">flying kites</Bloom>.
          {" "}Every year the kite-eating tree would get him. Every single year. But he always tried
          again, because{" "}
          <Bloom type="line" backgroundColor={c.highlight} paddingX={4} paddingY={2} scale={2}>
          ...
          nobody wanted.{" "}
          <Bloom type="line" backgroundColor={c.rose} paddingX={4} paddingY={2} scale={3} tip="square">
          ...
          <Bloom type="line" backgroundColor={c.highlight} paddingX={4} paddingY={2} scale={10}>
            that in-between feeling was very familiar to him.
          </Bloom>
        </p>

        <p style={{ fontSize: 15, lineHeight: 1.9, marginTop: 24, marginBottom: 0 }}>
          <Bloom paddingX={14} paddingY={10} scale={4} backgroundColor={c.highlight}>
            Sometimes I lie awake at night, and I ask, "Where have I gone wrong?" Then a voice says to me, "This is going to take more than one night."
          </Bloom>
        </p>

        <p style={{ fontSize: 12, marginTop: 40, opacity: 0.35, letterSpacing: "0.04em", textAlign: "right" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 56 }}>
          ...
          >
            wrap{" "}
            <Bloom type="line" color={c.bg} backgroundColor={c.rose} tip="square">
              anything
            </Bloom>
            {" "}with{" "}
